...
import AddProdutos from './Pages/Produtos/Add'
import ListaProdutos from "./Pages/Produtos/ListaProdutos";
import EditProdutos from "./Pages/Produtos/Edit";
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/adm/produtos/edit" element={<EditProdutos />} />
                <Route path="/adm/produtos/add" element={<AddProdutos />} />
