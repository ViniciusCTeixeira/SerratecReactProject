...
function createData( codigo:string, email: string, usuario: string, nome: string, cpf: string, telefone: string, nascimento: string): Data {
    return {
       codigo,
       email,
       usuario,
...
const rows = [
    createData("1","cauasmello@gmail.com", "cauasmello","Cauã Stulpen Mello", "172.564.678-91", "2248-7777","03/04/2004"),
    createData("2","aaa@123", "abc136", "Avilo", "786.322.522-78","2248-7707","03/04/2009")
];
...
export default function Funcionario() {
    ...
    const handleClick = (event: React.MouseEvent<unknown>, codigo: string) => {
