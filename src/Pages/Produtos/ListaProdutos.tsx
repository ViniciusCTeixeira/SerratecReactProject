...
const rows = [
    ...
    createData(4, "VideoGame", "Para jogar"),
    createData(5, "Celular", "Para Ligar"),
    createData(6, "Telefone", "Para Ligar"),
];
        ...
        >
            ...
            {numSelected > 0 ? (
                <Tooltip title="Delete">
                    <IconButton href='/adm/produtos/edit'>
                        <DeleteIcon/>
                    </IconButton>
                </Tooltip>
            ) : (
                <Tooltip title="Add">
                    <IconButton href='/adm/produtos/add'>
